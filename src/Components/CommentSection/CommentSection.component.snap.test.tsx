...
import type { Review } from './CommentSection.component.types';
...
describe('ReviewCard Component Snapshots', () => {
  ...
  const configs: SnapshotTestConfig<ReviewCardProps>[] = [
    {
    ...
    },
    {
      ...
      props: {
        ...
        review: {
          ...dummyReview,
          comment:
            'Produk ini memiliki kualitas yang sangat memuaskan, bahan fleksibel, jahitan rapi, paking aman dengan bubble wrap tebal, pengiriman tepat waktu, serta layanan customer service yang sangat ramah dan responsif saat dihubungi.',
        },
      },
    },
    {
  ...
  runSnapshotTests<ReviewCardProps>(ReviewCard, configs);
});