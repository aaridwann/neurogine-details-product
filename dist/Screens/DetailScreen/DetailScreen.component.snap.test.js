...
jest.mock('react-native/Libraries/Components/ScrollView/ScrollView', () => {
    ...
    return {
        __esModule: true,
        default: React.forwardRef(({ children, testID, style, contentContainerStyle, }, ref) => {
            const simpleProps = {
                testID,
                style,
...
jest.mock('react-native/Libraries/Lists/FlatList', () => {
    ...
    return {
        __esModule: true,
        default: ({ data, renderItem, testID, style, contentContainerStyle, horizontal, showsHorizontalScrollIndicator, }) => {
...
jest.mock('@Neurogine/ui-kit-button', () => ({
    ...
    default: jest.fn(({ title, onPress, disabled, testID, style }) => {
        ...
        return React.createElement('Button-UI-KIT', { testID: testID || 'mock-button', onPress, disabled, style }, safeTitle);
    }),
}));
...
describe('Detail Screen Component Snapshots', () => {
    ...
    runSnapshotTests(DetailScreenComponent, configs);
});
