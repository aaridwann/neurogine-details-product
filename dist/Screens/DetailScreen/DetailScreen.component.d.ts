...
declare const DetailScreenComponent: ({ data, isLoading, goBack, refetch, isRefecthing, selectProductSuggestion, showBottomSheet, onModalHide, }: DetailScreenComponentProps) => React.JSX.Element;
